...
def create_post(request):
    ...
    if request.method == "GET":
        ...
        return render(
            request, "todo/post_form.html", {"form": form}  # 呼び出す Template
        )  # Template に渡すデータ
    ...
    if request.method == "POST":
        ...
        return redirect("todo:read_post")
...
def read_post(request):
    ...
    return render(
        request, "todo/index.html", {"posts": posts}  # 呼び出す Template
    )  # Template に渡すデータ
...
def edit_post(request, post_id):
    ...
    if request.method == "GET":
        ...
        return render(
            request,
            "todo/post_form.html",  # 呼び出す Template
